  ...
  return (
    ...
    <div className="cos-tit">
     ...
     <div className='cos-content'>
            ...
            <p className='cos-content-main-p'>We focus on the various <span className='gradient-underline-pink'>astronomical and meteorological observations</span>, sky studies, operations of telescopes and special purpose sensors and cameras, composition of planets, motion of celestial bodies, eclipses, <span className="gradient-underline-blue">meteor showers, planetary alignments</span>, origin and evolution of the universe, astrobiology, <br /> Geeky astrophysical phenomena like <span className='gradient-underline-light-green'>black holes, neutron stars, nebulae, galaxy motions</span>, birth of starts and other concepts like gravity,space-time, twin paradox etc. To find the fundamental nature of the universe and our place within it</p>
      </div>
      <div className='cos-content2'>
            <ul className='cos-content2-p'>
              <li> Join us on <span className='gradient-underline-pink'>mesmerizing stargazing expeditions</span> where we explore the celestial marvels that adorn our night sky. </li>
             ...
             <li> Engage in thought-provoking conversations
              ...
              for intellectual discourse, where members can exchange ideas, challenge conventional wisdom, and <span className='gradient-underline-blue'>explore the 
      ...
      <img className='cos-content3-img' src='cos3.jpg' alt="cosmology3"/>
            <ul className='cos-content3-p'>
              <li>Participate in <span className='gradient-underline-light-green'>interactive workshops and demonstrations</span> where you can delve into 
